...
import static cj.geochat.middle.uc.mapper.UcLoggerLoginDynamicSqlSupport.*;
import static org.mybatis.dynamic.sql.SqlBuilder.isEqualTo;

import cj.geochat.middle.uc.model.UcLoggerLogin;
...
@Repository
public interface UcLoggerLoginMapper extends CommonCountMapper, CommonDeleteMapper, CommonInsertMapper<UcLoggerLogin>, CommonUpdateMapper {
    /**
     * @mbg.generated generated automatically, do not modify!
     */
    BasicColumn[] selectList = BasicColumn.columnList(id, eventType, eventTitle, userId, accountId, accountCate, sourceType, sourceDesc, message, status, ipAddress, osPlatform, ctime, year, month, day);

    /**
     * @mbg.generated generated automatically, do not modify!
     */
    @SelectProvider(type=SqlProviderAdapter.class, method="select")
    @Results(id="UcLoggerLoginResult", value = {
    ...
    List<UcLoggerLogin> selectMany(SelectStatementProvider selectStatement);

    /**
     * @mbg.generated generated automatically, do not modify!
     */
    @SelectProvider(type=SqlProviderAdapter.class, method="select")
    @ResultMap("UcLoggerLoginResult")
    Optional<UcLoggerLogin> selectOne(SelectStatementProvider selectStatement);

    /**
     * @mbg.generated generated automatically, do not modify!
     */
    default long count(CountDSLCompleter completer) {
        return MyBatis3Utils.countFrom(this::count, ucLoggerLogin, completer);
    }
    ...
    default int delete(DeleteDSLCompleter completer) {
        return MyBatis3Utils.deleteFrom(this::delete, ucLoggerLogin, completer);
    }
     ...
     * @mbg.generated generated automatically, do not modify!
     */
    default int insert(UcLoggerLogin row) {
        return MyBatis3Utils.insert(this::insert, row, ucLoggerLogin, c ->
     ...
     * @mbg.generated generated automatically, do not modify!
     */
    default int insertMultiple(Collection<UcLoggerLogin> records) {
        return MyBatis3Utils.insertMultiple(this::insertMultiple, records, ucLoggerLogin, c ->
            c.map(id).toProperty("id")
            .map(eventType).toProperty("eventType")
            .map(eventTitle).toProperty("eventTitle")
            .map(userId).toProperty("userId")
     ...
     * @mbg.generated generated automatically, do not modify!
     */
    default int insertSelective(UcLoggerLogin row) {
        return MyBatis3Utils.insert(this::insert, row, ucLoggerLogin, c ->
     ...
     * @mbg.generated generated automatically, do not modify!
     */
    default Optional<UcLoggerLogin> selectOne(SelectDSLCompleter completer) {
        return MyBatis3Utils.selectOne(this::selectOne, selectList, ucLoggerLogin, completer);
    }

    /**
     * @mbg.generated generated automatically, do not modify!
     */
    default List<UcLoggerLogin> select(SelectDSLCompleter completer) {
        return MyBatis3Utils.selectList(this::selectMany, selectList, ucLoggerLogin, completer);
    }

    /**
     * @mbg.generated generated automatically, do not modify!
     */
    default List<UcLoggerLogin> selectDistinct(SelectDSLCompleter completer) {
        return MyBatis3Utils.selectDistinct(this::selectMany, selectList, ucLoggerLogin, completer);
    }

    /**
     * @mbg.generated generated automatically, do not modify!
     */
    default Optional<UcLoggerLogin> selectByPrimaryKey(String id_) {
        return selectOne(c ->
            c.where(id, isEqualTo(id_))
        );
    }
    ...
    default int update(UpdateDSLCompleter completer) {
        return MyBatis3Utils.update(this::update, ucLoggerLogin, completer);
    }

    /**
     * @mbg.generated generated automatically, do not modify!
     */
    static UpdateDSL<UpdateModel> updateAllColumns(UcLoggerLogin row, UpdateDSL<UpdateModel> dsl) {
     ...
     * @mbg.generated generated automatically, do not modify!
     */
    static UpdateDSL<UpdateModel> updateSelectiveColumns(UcLoggerLogin row, UpdateDSL<UpdateModel> dsl) {
     ...
     * @mbg.generated generated automatically, do not modify!
     */
    default int updateByPrimaryKey(UcLoggerLogin row) {
        return update(c ->
     ...
     * @mbg.generated generated automatically, do not modify!
     */
    default int updateByPrimaryKeySelective(UcLoggerLogin row) {
        return update(c ->
