...
import cj.geochat.uc.middle.web.rest.ILoginAccountRestfull;
...
@FeignClient(contextId = "loginAccountRemote", value = "cj-geochat-uc-middle", url = "${app.test.feign.adapter.docker.uc.url:}")
