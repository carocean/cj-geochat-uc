...
import cj.geochat.middle.uc.web.rest.IUserDeviceRestfull;
...
@FeignClient(contextId = "userDeviceRemote", value = "cj-geochat-middle-uc", url = "${app.test.feign.adapter.docker.uc.url:}")
